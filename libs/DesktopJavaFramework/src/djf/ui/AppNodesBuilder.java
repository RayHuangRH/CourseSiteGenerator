...
public class AppNodesBuilder{
	...
	public ImageView buildImage(Object nodeId,
			GridPane parent,
			int col, int row, int colSpan, int rowSpan,
			String styleClass,
			boolean enabled) {
		PropertiesManager props = PropertiesManager.getPropertiesManager();
		String iconProperty = nodeId.toString();
		String imagePath = FILE_PROTOCOL + PATH_ICONS + props.getProperty(iconProperty);
		Image image = new Image(imagePath);
		ImageView iv = new ImageView(image);
		if (!image.isError()) {
			initNode(iconProperty, iv, parent, col, row, colSpan, rowSpan, styleClass, enabled);
		}
		return iv;
	}
	...
	public TitledPane buildTitledPane(Object nodeId,
		...
		// INITIALIZE THE OTHER SETTINGS
		this.initNode(nodeId, titlePane, parentPane, styleClass, enabled);

		// MAKE SURE THE LANGUAGE MANAGER HAS IT
		// SO THAT IT CAN CHANGE THE LANGUAGE AS NEEDED
		initLabeledNode(nodeId, titlePane);
	...
	public TitledPane buildTitledPane(Object nodeId,
		...
		titlePane.setExpanded(false);
		// INITIALIZE THE OTHER SETTINGS
		initNode(nodeId, titlePane, parent, col, row, colSpan, rowSpan, styleClass, enabled);
	...
	public TextArea buildTextArea(Object nodeId,
		...
		initNode(nodeId, area, parentPane, styleClass, enabled);
		return area;
	}
	...
	public TextArea buildTextArea(Object nodeId,
		...
		TextArea area = new TextArea();
		area.setWrapText(true);
		initNode(nodeId, area, parent, col, row, colSpan, rowSpan, styleClass, enabled);
		return area;
	}
	...
	public DatePicker buildDatePicker(Object nodeId,
		...
		initNode(nodeId, date, parent, styleClass, enabled);
		return date;
	}
	...
	public DatePicker buildDatePicker(Object nodeId,
			...
			boolean enabled) {
		DatePicker date = new DatePicker();
		initNode(nodeId, date, parent, col, row, colSpan, rowSpan, styleClass, enabled);
		return date;
	}
